...
int I2C_MasterTransferData(int, int);//LPC_I2C_TypeDef *I2Cx, I2C_M_SETUP_Type *TransferCfg, I2C_TRANSFER_OPT_Type Opt);
int I2C_M_SETUP_Type_malloc(void);
int I2C_M_SETUP_Type_sl_addr7bit(int, int);
int I2C_M_SETUP_Type_tx_data(int, int);
int I2C_M_SETUP_Type_tx_length(int, int);
int I2C_M_SETUP_Type_rx_data(int, int);
int I2C_M_SETUP_Type_rx_length(int, int);
int I2C_M_SETUP_Type_retransmissions_max(int, int);
